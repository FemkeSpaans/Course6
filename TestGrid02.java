...
import javax.swing.border.EmptyBorder;
    ...
    public class TestGrid02  {
        ...
        private final void initUI() {
            ui = new JPanel(new BorderLayout(5, 5));// what does this do?? vertical and horizontal gaps, but what does that mean???
            //ui.setBackground(Color.YELLOW);
            ui.setBorder(new EmptyBorder(4, 4, 4, 4)); // A class which provides an empty, transparent border which takes up space but does no drawing.
            createMap(15, 15); // different method which requires a maxX and a maxY
            ui.add(gameGrid);
